...
Verification: SKILL.md Phase 3 Review § "Update in place on resolution" and "Lifecycle: mutable until resolved, then frozen" subsections; `agents/reviewer.md` Rules.
